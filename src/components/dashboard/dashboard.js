        ...
        <>
            ...
            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                ...
                <Link
                    ...
                    <i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report</Link>
            </div>
            <div class="row">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown no-arrow"><button class="btn btn-link btn-sm dropdown-toggle"
                                ...
                                <div class="dropdown-menu shadow dropdown-menu-end animated--fade-in">
                                    <p class="text-center dropdown-header">dropdown header:</p><Link
                                        class="dropdown-item" href="#">&nbsp;Action</Link><Link class="dropdown-item"
                                            href="#">&nbsp;Another action</Link>
                                    <div class="dropdown-divider"></div><Link class="dropdown-item"
