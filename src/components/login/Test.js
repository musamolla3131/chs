                                ...
                                <div class="row">
                                    <div class="col-lg-6 d-none d-lg-flex">
                                        <div class="flex-grow-1 bg-login-image"
                                            style={{ background: `url('${bg_image}') center / contain no-repeat` }}>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="p-5">
                                            ...
                                            <form class="user">
                                                ...
                                                <hr /><a class="btn btn-primary d-block btn-google btn-user w-100 mb-2"
                                                    role="button" href='to'><i class="fab fa-google"></i>&nbsp; Login with Google</a><a
                                                        class="btn btn-primary d-block btn-facebook btn-user w-100" role="button" href='to'><i
